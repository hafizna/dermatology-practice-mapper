...
def _parse_columbia_asia(entries: list[dict]) -> list[ParsedScheduleSlot]:
    return _parse_freetext_day_time(entries, source="columbia_asia")


def _parse_radjak(entries: list[dict]) -> list[ParsedScheduleSlot]:
